...
function lose(userChoice, computerChoice){
    ...
    const smallCompWord = "comp".fontsize(3).sub()
    const userChoice_div = document.getElementById(userChoice)
    result_p.innerHTML = `${convertToWord(userChoice)}${smallUserWord} loses ${convertToWord(computerChoice)}${smallCompWord} , You losts...😞`;
...
//     t = console.log("hey you clicked on the rock")
// }